...
function creativefocus_scripts() {
	...
	// wp_enqueue_style( 'creativefocus-style', get_template_directory_uri() . '/styles/style' . '.css', array(), $creativefocus_version );
	// wp_enqueue_script( 'creativefocus-script', get_template_directory_uri() . '/assets/js/theme'  . '.js', array( 'jquery' ), $creativefocus_version, true );
